    ...
    useEffect(() => {
        ...
        async function confirm() {
            try {
                ...
                const data = await contactSubscribeConfirm({token: token, list_id: listId,});
                console.log(data)
                setSuccess(true);
            } catch (err) {
                setError(true);
    ...
    if (error) {
        return (
            <div className="flex flex-col justify-center my-auto items-center w-full">
                <h1 className="text-red-600 font-bold">Subscription could not be confirmed</h1>
    ...
    if (success) {
        return (
            <div className="flex flex-col justify-center items-center w-full my-auto">
                <h1 className="uppercase font-bold text-2xl mb-2">Subscription_confirmed</h1>
