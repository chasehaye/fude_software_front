...
function ContactUnsubscribe() {
    ...
    if (confirmed) {
        ...
        <div className="flex flex-col justify-center items-center w-full my-auto">
            ...
            <p className="text-center">You have successfully unsubscribed from {listName}</p>
        </div>
        )
    }
    ...
    return(
        ...
        <div className="m-auto">
            <button onClick={handleSubmit} className="border border-edge hover:border-hover px-4 py-6 w-40 cursor-pointer hover:text-hoverc transition-colors hover:bg-hoverc/10">Unsubscribe</button>
            {error && (
