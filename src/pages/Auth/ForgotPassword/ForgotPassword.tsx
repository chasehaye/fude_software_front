  ...
  return (
    <>
      <div className="border-b border-edge text-center h-14 flex justify-center sm:justify-between w-full flex-shrink-0">
        <Link
          to="/"
          className="px-10 sm:px-20 sm:border-r sm:border-edge flex items-center justify-center cursor-pointer select-none hover:bg-hoverc/10 transition-all hover:text-hoverc"
        >
          Return
        </Link>
