    ...
    return(
        <>
            <div className="border-b border-edge text-center h-14 flex justify-center sm:justify-between w-full flex-shrink-0">
                <Link to="/" className="px-10 sm:px-20 sm:border-r sm:border-edge pt-4 select-none hover:bg-hoverc/10 transition-all hover:text-hoverc items-center inline-block">Return</Link>
                <div className="hidden sm:block px-20 sm:border-l sm:border-edge pt-4 whitespace-nowrap select-none">Sign In</div>
            </div>
            <div className="flex flex-col items-center justify-center flex-grow px-4">
                <FormHeader text={"Sign back into your account"} />
                <form autoComplete="off" onSubmit={handleSubmit} className="flex flex-col w-full max-w-80">
                    ...
                    <Link to="/forgot-password" className="text-xs underline cursor-pointer mt-1" >Forgot Password</Link>
