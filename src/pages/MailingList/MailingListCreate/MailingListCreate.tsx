...
function MailingListCreate(){
    ...
    const isInvalid = !formData.name_internal.trim() || !formData.name_external.trim();
    ...
    return(
        <div className="flex flex-col min-h-screen font-roboto uppercase">
            ...
            <div className="flex flex-col items-center justify-center flex-grow px-4 mt-10">
                <form autoComplete="off" onSubmit={handleSubmit} className="flex flex-col gap-4 w-full max-w-80">
                    <FormHeader text={"Create New Mailing List"} />

                    <FormField fieldName="List Name Internal" type="text" name="name_internal" value={formData.name_internal} onChange={handleChange} isRequired={true} />
                    <FormField fieldName="List Name External" type="text" name="name_external" value={formData.name_external} onChange={handleChange} isRequired={true} />

                    <FormSubmitButton buttonText={"Create List"} isInvalid={isInvalid || loading} />
