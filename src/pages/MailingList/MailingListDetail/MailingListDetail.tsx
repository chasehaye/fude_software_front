...
import { deleteList, getList } from "../../../utils/list-api";
      ...
      return (
        ...
        <NavBar />
          <div className="flex flex-col items-center justify-center h-64 text-center">
              ...
              <p className="mb-6">Mailing list <span className="text-white text-bold">_{list?.name}_</span> has been removed.</p>
              <Link 
  ...
  if (status === "confirming") {
    return (
      ...
      <div className="m-6 p-6 border-2 border-red-500 mt-20">
        <h2 className="text-lg font-bold text-red-700">Are you absolutely sure?</h2>
        <p className="mb-4">
          This will permanently delete the list and all associated subscribers and messages.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
          <DeleteButton onDelete={handleDelete} text="Yes, Delete Permanently" />
          <CancelButton onCancel={() => setStatus("idle")} text="No, Keep List" />
        </div>
      </div>
      </>
    );
    ...
    <NavBar />
      <div className="p-6">
          <div className="flex flex-col md:flex-row justify-between items-start border-b border-edge pb-6 pt-10">
              ...
              {status === "idle" && (<DeleteButton onDelete={() => setStatus("confirming")} text="Delete" />)}
          </div>
